...
export default function SuperAdminPage() {
  ...
  // Quick unlock/auth simulation for SuperAdmin view
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-purple-950/40 via-slate-900 to-indigo-950/40 border border-purple-800/30 p-6 rounded-3xl">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white">
              Gestión de Negocios, Escaneos y Facturación
            </h1>
            <p className="text-xs text-slate-400 mt-1">
              Supervisión de todos los comercios inscritos, estado de los QRs y telemetría de redirección.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-lg relative overflow-hidden">
              ...
              <p className="text-[11px] text-slate-500 mt-2">
                {metrics.directModeCount} en Modo 5⭐ &bull; {metrics.smartLandingModeCount} en Smart Landing
              </p>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-lg relative overflow-hidden">
              ...
              <div className="mt-3 flex items-baseline gap-2">
                <span className="text-3xl font-black text-white">
                  {metrics.totalScansGlobal.toLocaleString()}
                </span>
                <span className="text-xs font-semibold text-blue-400">&lt;100ms</span>
              </div>
              <p className="text-[11px] text-slate-500 mt-2">
                Tráfico total redirigido por Vercel Edge
              </p>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-lg relative overflow-hidden">
              ...
              <div className="mt-3 flex items-baseline gap-2">
                <span className="text-3xl font-black text-white">
                  {metrics.scansTodayGlobal.toLocaleString()}
                </span>
                <span className="text-xs font-semibold text-amber-400">en vivo</span>
              </div>
              <p className="text-[11px] text-slate-500 mt-2">
                Interacciones en el punto de venta hoy
              </p>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-lg relative overflow-hidden">
              ...
              <div className="mt-3 flex items-baseline gap-2">
                ...
                <span className="text-xs font-semibold text-emerald-400">USD / mes</span>
              </div>
              <p className="text-[11px] text-slate-500 mt-2">
                Basado en planes activos de clientes
              </p>
            </div>
          </div>
        )}
            ...
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="border-b border-slate-800 text-slate-400 font-semibold uppercase tracking-wider text-[10px]">
                  <th className="py-3 px-4">Negocio / Slug</th>
